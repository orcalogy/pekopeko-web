...
part 'restaurant_search_item.g.dart';
...
/// * [providerRefs] 
@BuiltValue()
abstract class RestaurantSearchItem implements Built<RestaurantSearchItem, RestaurantSearchItemBuilder> {
  ...
  RestaurantSearchItem._();

  factory RestaurantSearchItem([void updates(RestaurantSearchItemBuilder b)]) = _$RestaurantSearchItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RestaurantSearchItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RestaurantSearchItem> get serializer => _$RestaurantSearchItemSerializer();
}

class _$RestaurantSearchItemSerializer implements PrimitiveSerializer<RestaurantSearchItem> {
  @override
  final Iterable<Type> types = const [RestaurantSearchItem, _$RestaurantSearchItem];

  @override
  final String wireName = r'RestaurantSearchItem';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RestaurantSearchItem object, {
  ...
  void _deserializeProperties(
    ...
    required RestaurantSearchItemBuilder result,
  ...
  @override
  RestaurantSearchItem deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RestaurantSearchItemBuilder();
